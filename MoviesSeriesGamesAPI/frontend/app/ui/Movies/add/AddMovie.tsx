  ...
  return (
        <>
...

            {
                ...
                >
                    <div
                        className='rounded-lg animate-appear-fast border bg-white opacity-100 w-full md:w-[38rem] lg:w-[48rem] h-[60%] duration-150 flex items-center justify-center'
                    >
                        <button
                        ...
                        <AddMovieForm handleCloseModal={() => setShow(false)} />
                    </div>
                </div>
            }
